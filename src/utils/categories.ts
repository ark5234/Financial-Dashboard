...
export const CATEGORY_CONFIG: Record<string, { color: string; fill: string; Icon: React.ElementType }> = {
  ...
  Transport:      { color: 'bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900/40 dark:text-fuchsia-300',   fill: '#D946EF', Icon: Car },
  ...
  Dining:         { color: 'bg-pink-100 text-pink-800 dark:bg-pink-900/40 dark:text-pink-300', fill: '#EC4899', Icon: ForkKnife },
  ...
  // Savings categories
  'Emergency Fund': { color: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300', fill: '#10B981', Icon: PiggyBank },
